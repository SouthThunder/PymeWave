                ...
                <div className="container">
                    ...
                    <form id="form" onSubmit={store}>
                        <div className="inputbox">
                            ...
                            <input placeholder="pepe123@gmail.com" type="email" id="Correo" name="correo" value={correo} onChange={(e)=>setcorreo(e.target.value)} />
                            <label for="">Correo Electronico</label>
                        </div>
                        <div className="inputbox">
                            <small className="errores">Error message</small>
                            <ion-icon name="person"></ion-icon>
                            <input  placeholder="pepe" type="text" id="nombre" name="nombre" value={nombre} onChange={(e)=>setnombre(e.target.value)} />                   
                            <label for="">Nombre</label>
                        </div>
                        <div className="inputbox">
                            <small className="errores">Error message</small>
                            <ion-icon name="person"></ion-icon>
                            <input placeholder="Gonzales" type="text" id="apellidos" name="apellidos" value={apellidos} onChange={(e)=>setapellidos(e.target.value)}/>
                        ...
                        <div className="inputbox">
                            ...
                            <input placeholder="3187927635" type="text" id="Telefono" name="telefono" value={telefono} onChange={(e)=>settelefono(e.target.value)}  />
